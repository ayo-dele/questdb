...
public class IndexedParameterUnknownTypeLinkFunction implements ScalarFunction, UnknownTypeFunction {
    private final int variableIndex;
    private final int position;
    private int type = -1;
    private Function base;

    public IndexedParameterUnknownTypeLinkFunction(int variableIndex, int position) {
