...
public class NamedParameterUnknownTypeLinkFunction implements ScalarFunction, UnknownTypeFunction {
    private final String variableName;
    private final int position;
    private int type = -1;
    private Function base;

    public NamedParameterUnknownTypeLinkFunction(String variableName, int position) {
